...
export SPH_PARAM_B="${SPH_PARAM_B:-5e5}"
...
export SPH_PARAM_INIT_A0_P1="$(($boxl + $dx/2)) $(($boxb + $dx/2)) 0."
...
export SPH_PARAM_INIT_A1_P1="$mx   $(($boxb + $dx/2)) 0."
export SPH_PARAM_INIT_A1_P2="$(($boxr - $dx/2)) $my   0."
export SPH_PARAM_INIT_A1_FREE="0"
export SPH_PARAM_INIT_A1_SURFACE_Y="$boxt"
export SPH_PARAM_INIT_A1_FILL="0"

export SPH_PARAM_INIT_A2_P1="$(($boxl + $dx/2))  $my   0."
export SPH_PARAM_INIT_A2_P2="$mx    $(($boxt - $dx/2)) 0."
export SPH_PARAM_INIT_A2_FREE="0"
export SPH_PARAM_INIT_A2_FILL="0"

export SPH_PARAM_INIT_A3_P1="$mx    $my   0."
export SPH_PARAM_INIT_A3_P2="$(($boxr - $dx/2))  $(($boxt - $dx/2)) 0."
