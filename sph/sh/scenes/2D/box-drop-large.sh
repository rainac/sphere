...
export SPH_PARAM_INIT_A4_P1="0.48 1.1  0."
export SPH_PARAM_INIT_A4_P2="0.52 1.14 0."
export SPH_PARAM_INIT_A4_V="0 3 0"

python $SPH_ROOT/sh/genbox-2d.py -l 0 -r 1 -d 0 -u 2 -x $(( $SPH_PARAM_DX / $SPH_PARAM_BRES )) > $SPH_PARAM_BOUNDARY_FILE
