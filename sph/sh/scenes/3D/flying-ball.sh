...
export SPH_PARAM_QUADER_P2="2 2 2"
...
export SPH_PARAM_INIT_A0_PATTERN="sphere_alt" # 0 square, 1 sphere, 2 sphere type 2
export SPH_PARAM_INIT_A0_P1="1   1   1"
export SPH_PARAM_INIT_A0_P2="1.5 1.5  1.5"
export SPH_PARAM_INIT_A0_V="${SPH_PARAM_INIT_A0_V:-100 -100 -100}"
